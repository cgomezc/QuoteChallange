...
namespace Quote
{
    public class Mapper : IMapper
    {
        ...
        public TourQuoteResponse Convert(TourQuoteRequest request, ActivitiesDetailResponse activity)
        {
            ...
            var baseSelectedQuote = FirstOrFallback(tourQuotes, new TourQuote());  
            var margin = .25;
        ...
        public static T FirstOrFallback<T>(List<T> list, T fallback) where T : new()
        {
            return list.FirstOrDefault() != null ? list.First() : fallback;
        }
